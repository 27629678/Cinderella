    ...
    int       nCmdShow)
{
    ...
    return HuiguniangPlayer::createAndRun();
}

int HuiguniangPlayer::createAndRun(void)
{
    HuiguniangPlayer *host = HuiguniangPlayer::sharedInstance();
    int ret = host->run();
    HuiguniangPlayer::purgeSharedInstance();
    return ret;
}

HuiguniangPlayer *HuiguniangPlayer::s_sharedInstance = NULL;

HuiguniangPlayer *HuiguniangPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new HuiguniangPlayer();
    }
    return s_sharedInstance;
}

void HuiguniangPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
HuiguniangPlayer::HuiguniangPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int HuiguniangPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "huiguniang-player");
...
void HuiguniangPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void HuiguniangPlayer::createViewMenu(void)
{
...
void HuiguniangPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void HuiguniangPlayer::updateWindowTitle(void)
{
}

void HuiguniangPlayer::relaunch(void)
{
...
void HuiguniangPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void HuiguniangPlayer::onFileOpenProject(void)
{
...
void HuiguniangPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"HuiguniangPlayer");
...
void HuiguniangPlayer::onFileProjectConfig(void)
{
...
void HuiguniangPlayer::onFileRelaunch(void)
{
    relaunch();
}

void HuiguniangPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void HuiguniangPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void HuiguniangPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void HuiguniangPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void HuiguniangPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT HuiguniangPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    HuiguniangPlayer *host = HuiguniangPlayer::sharedInstance();
...
INT_PTR CALLBACK HuiguniangPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
